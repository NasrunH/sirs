...
<body class="bg-mainbg flex items-center justify-center min-h-screen">
    ...
    <div class="bg-card w-full max-w-md p-8 rounded-xl shadow-lg border border-bordercolor">
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-5">
            ...
            <div class="mt-5 border-t border-bordercolor pt-5 text-center text-sm text-textmain">
                Pasien baru? <a href="{{ route('register') }}" class="text-primary font-bold hover:underline">Buat akun Rekam Medis</a>
            </div>
        </form>
